...
function TypeSelector({setPage}) {
    ...
    return (
        <div className="tab-nav-bar z-10">
            <div className="tab-navigation">
                ...
                <ul className="tab-menu" ref={tabMenuRef}>
                    <li className="tab-btn active" onClick={(e) => handleTabClick(e, 1)}>Inventario</li>
                    <li className="tab-btn" onClick={(e) => handleTabClick(e, 2)}>Crear Producto</li>
                    <li className="tab-btn" onClick={(e) => handleTabClick(e, 3)}>Categorías</li>
                    <li className="tab-btn" onClick={(e) => handleTabClick(e, 4)}>Crear Categoría</li>
                </ul>
            </div>
        </div>
    )
