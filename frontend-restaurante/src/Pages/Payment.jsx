    ...
    return (
        <div className="min-h-screen flex flex-col justify-center lg:px-32 px-5 py-10 mt-16 gap-6">
            ...
            <div
                ...
                <h2 className="font-bold text-lg lg:text-xl p-2 text-[#f25e53] w-full text-end">Subtotal: $</h2>
            </div>
            ...
            <div className="flex flex-col lg:flex-row w-full gap-6">
                ...
                <span
                    className="md:text-lg text-[#0D0D0D] overflow-hidden overflow-ellipsis whitespace-nowrap "> Hola
                </span>
                    </div>
                    <button
            ...
            <div
                ...
                <h2 className="font-bold text-lg lg:text-xl p-2 text-[#f25e53] w-full text-start">Total (+IVA) : $</h2>
                <button
